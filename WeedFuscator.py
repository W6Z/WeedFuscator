...
text = '''
                                        ...
                                        ED.            Et                                                           :                
                            ,;        ,;E#Wi           E#t      :             .      .,                            t#,               
                          f#i       f#i E###G.         E##t     Ef           ;W     ,Wt                           ;##W.   j.         
            ;           .E#t      .E#t  E#fD#W;        E#W#t    E#t         f#E    i#D.            .. GEEEEEEEL  :#L:WE   EW,        
          .DL          i#W,      i#W,   E#t t##L       E#tfL.   E#t       .E#f    f#f             ;W, ,;;L#K;;. .KG  ,#D  E##j       
  f.     :K#L     LWL L#D.      L#D.    E#t  .E#K,     E#t      E#t      iWW;   .D#i             j##,    t#E    EE    ;#f E###D.     
  EW:   ;W##L   .E#f:K#Wfff;  :K#Wfff;  E#t    j##f ,ffW#Dffj.  E#t fi  L##Lffi:KW,             G###,    t#E   f#.     t#iE#jG#W;    
  E#t  t#KE#L  ,W#; i##WLLLLt i##WLLLLt E#t    :E#K: ;LW#ELLLf. E#t L#jtLLG##L t#f            :E####,    t#E   :#G     GK E#t t##f   
  E#t f#D.L#L t#K:   .E#L      .E#L     E#t   t##L     E#t      E#t L#L  ,W#i   ;#G          ;W#DG##,    t#E    ;#L   LW. E#t  :K#E: 
  E#jG#f  L#LL#G       f#E:      f#E:   E#t .D#W;      E#t      E#tf#E: j#E.     :KE.       j###DW##,    t#E     t#f f#:  E#KDDDD###i
  E###;   L###j         ,WW;      ,WW;  E#tiW#G.       E#t      E###f .D#j        .DW:     G##i,,G##,    t#E      f#D#;   E#f,t#Wi,,,
  E#K:    L#W;           .D#;      .D#; E#K##i         E#t      E#K, ,WK,           L#,  :K#K:   L##,    t#E       G#t    E#t  ;#W:  
  EG      LE.              tt        tt E##D.          E#t      EL   EG.             jt ;##D.    L##,     fE        t     DWi   ,KK: 
  ;       ;@                            E#t            ;#t      :    ,                  ,,,      .,,       :                         
                                        L:              :;                                                                           
...
Anime.Fade(Center.Center(banner), Colors.green_to_yellow, Colorate.Vertical, enter=True)

def main():
    System.Clear()

    print("\n"*2)
    print(Colorate.Diagonal(Colors.green_to_yellow, Center.XCenter(text)))
    print("\n"*5)


    _file = Write.Input("Drag files in -> ", Colors.green_to_yellow, interval=0.005)



    if not _file.strip() or not isfile(_file):
        Colorate.Error("Didn't work lmao")
        return
    ...
    # print()
    # key = Write.Input("Enter your encryption key (3 - 1000000) -> ", Colors.green_to_yellow, interval=0.005)
    ...
    print(Colorate.Diagonal(Colors.green_to_yellow, f"""Crypting with Kyrie Eleison...
Using key {key}...
...
Making the final content..."""))
    ...
    print(Colorate.Diagonal(Colors.green_to_yellow, """Creating PYC file...
Moving the PYC file...
...
Renaming PYC file..."""))
    ...
    Write.Input("Built!", Colors.green_to_yellow, interval=0.005)
    return exit()
